...
3. Busca **Integración de plataformas de donaciones** → **PayPal**
...
:::warning Advertencia
La URL de Webhook contiene un token exclusivo, por lo que no debes compartirla públicamente. Si sospechas que se ha filtrado, puedes hacer clic en **Volver a obtener URL** para emitir una nueva (la URL anterior quedará invalidada de inmediato).
:::
...
Una vez completada la configuración, cuando los espectadores realicen pagos a través de PayPal, Stream Toolkit recibirá las notificaciones en tiempo real.
