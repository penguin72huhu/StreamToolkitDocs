...
Este tutorial explica cómo obtener la **API Key** y el **ID de canal** de la YouTube Data API, utilizados para la función `Marcador de momentos destacados de stream`.
...
Sí. La YouTube Data API v3 tiene un cupo diario gratuito de 10,000 unidades. El uso normal para streaming no lo superará.
...
No se recomienda. Si la clave se filtra y se abusa de ella, tu cupo diario se agotará rápidamente.
