...
2. Haz clic en **Ajustes** en el menú de la parte inferior izquierda → **Integración de plataformas de donación** → **Stripe** (Haz clic para expandir)
...
4. Pega la clave secreta en el campo **Clave de firma del Webhook**
...
Asegúrate de que la Clave de firma del Webhook se haya pegado y guardado correctamente, y que la URL del punto de conexión en el panel de Stripe coincida exactamente con la que se muestra en la app.
